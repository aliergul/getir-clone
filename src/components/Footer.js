      ...
      <div className="container mx-auto">
        ...
        <div className="flex justify-between items-center border-t border-gray-100 mt-6 py-6">
          ...
          <nav className="flex gap-x-3">
            ...
            <a href="/#" className="h-8 flex items-center px-2 border border-gray-100 text-sm gap-x-2 rounded text-gray-500 transition-colors hover:bg-primary-brand-color hover:bg-opacity-10 hover:border-transparent hover:text-primary-brand-color">
              <BiGlobe size={18}/>
              Türkçe (TR)
            </a>
          </nav>
